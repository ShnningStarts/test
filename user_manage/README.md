# user_manage serverless API
The user_manage project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=user_manage -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-spring-archetype -DarchetypeVersion=1.3.1 -DgroupId=com.smart -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd user_manage
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "User_manageApi",
                    "OutputKey": "User_manageApi",
